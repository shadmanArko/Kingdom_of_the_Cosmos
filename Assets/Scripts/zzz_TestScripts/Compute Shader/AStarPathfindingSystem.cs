...
namespace zzz_TestScripts.Compute_Shader
{
    public class EnemyMovementSystemUsingComputeShader : MonoBehaviour
    {
        ...
        private UnityEngine.ComputeBuffer enemyBuffer;
        ...
        void Start()
        {
            ...
            enemyBuffer = new UnityEngine.ComputeBuffer(enemyCount, sizeof(float) * 4);
